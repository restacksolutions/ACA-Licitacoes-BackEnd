...
class InviteMemberDto {
    constructor() {
        this.role = client_1.RoleCompany.member;
    }
}
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'member', enum: client_1.RoleCompany }),
    (0, class_validator_1.IsEnum)(client_1.RoleCompany),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin', enum: client_1.RoleCompany }),
    (0, class_validator_1.IsEnum)(client_1.RoleCompany),
    __metadata("design:type", String)
...
], MemberResponseDto.prototype, "user", void 0);
