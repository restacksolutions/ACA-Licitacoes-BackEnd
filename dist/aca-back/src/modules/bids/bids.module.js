...
exports.BidsModule = BidsModule = __decorate([
    (0, common_1.Module)({ providers: [bids_service_1.BidsService, jwt_strategy_1.JwtStrategy, supabase_auth_service_1.SupabaseAuthService], controllers: [bids_controller_1.BidsController] })
], BidsModule);
